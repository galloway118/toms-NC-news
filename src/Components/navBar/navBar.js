...
const Navbar = ({navBarClickHandler, username, handleLogOut}) => { 
    ...
    <header className="navbar">
        <nav className="navbar_links">
            ...
            {(username !== null)? 
            <img className="tomglogo" src="https://media.licdn.com/dms/image/C5603AQHz6b92YS5oiQ/profile-displayphoto-shrink_200_200/0?e=1583366400&v=beta&t=XXmAMwLi8vDmprq4JrHC9QDVZc99ImxJjCqcQH2BCJM" alt="user"></img>:
            <p> no user</p> }
